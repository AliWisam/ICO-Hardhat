...
async function main() {
  ...
  // const ExmplToken = await hre.ethers.getContractFactory("ExmplToken");
  
  // const instance = await upgrades.deployProxy(ExmplToken,[]);

  // await instance.deployed();
  // // const exampleToken = await ExmplToken.deploy();
  ...
  // console.log("deployed at:", instance.address);
    ...
    const ExmplToken = await hre.ethers.getContractFactory("ExmplToken");
    let exmplToken;
    exmplToken = await upgrades.deployProxy(ExmplToken, {
      initializer: "initialize",
    });
    await exmplToken.deployed();
    console.log("\nDeploying Contracts");
    console.log("\nChimera deployed to:", exmplToken.address);
    let content = exmplToken.address;
